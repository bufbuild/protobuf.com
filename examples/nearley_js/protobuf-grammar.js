...
var grammar = {
    ...
    {"name": "SyntaxDecl", "symbols": [{"literal":"edition"}, {"literal":"="}, "Edition", {"literal":";"}]},
    {"name": "SyntaxLevel", "symbols": ["StringLiteral"]},
    {"name": "Edition", "symbols": ["StringLiteral"]},
    ...
    {"name": "ImportDecl$ebnf$1$subexpression$1", "symbols": [{"literal":"option"}]},
    ...
    {"name": "SymbolVisibility", "symbols": [{"literal":"export"}]},
    {"name": "SymbolVisibility", "symbols": [{"literal":"local"}]},
    ...
    {"name": "MessageDecl$ebnf$1", "symbols": ["SymbolVisibility"], "postprocess": id},
    {"name": "MessageDecl$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "MessageDecl$ebnf$2", "symbols": []},
    {"name": "MessageDecl$ebnf$2", "symbols": ["MessageDecl$ebnf$2", "MessageElement"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "MessageDecl", "symbols": ["MessageDecl$ebnf$1", {"literal":"message"}, "MessageName", {"literal":"{"}, "MessageDecl$ebnf$2", {"literal":"}"}]},
    ...
    {"name": "MessageReservedDecl$subexpression$1", "symbols": ["NameStrings"]},
    ...
    {"name": "NameStrings$ebnf$1", "symbols": []},
    {"name": "NameStrings$ebnf$1$subexpression$1", "symbols": [{"literal":","}, "StringLiteral"]},
    {"name": "NameStrings$ebnf$1", "symbols": ["NameStrings$ebnf$1", "NameStrings$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "NameStrings", "symbols": ["StringLiteral", "NameStrings$ebnf$1"]},
    {"name": "Names$ebnf$1", "symbols": []},
    {"name": "Names$ebnf$1$subexpression$1", "symbols": [{"literal":","}, "Identifier"]},
    {"name": "Names$ebnf$1", "symbols": ["Names$ebnf$1", "Names$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "Names", "symbols": ["Identifier", "Names$ebnf$1"]},
    {"name": "EnumDecl$ebnf$1", "symbols": ["SymbolVisibility"], "postprocess": id},
    {"name": "EnumDecl$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "EnumDecl$ebnf$2", "symbols": []},
    {"name": "EnumDecl$ebnf$2", "symbols": ["EnumDecl$ebnf$2", "EnumElement"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "EnumDecl", "symbols": ["EnumDecl$ebnf$1", {"literal":"enum"}, "EnumName", {"literal":"{"}, "EnumDecl$ebnf$2", {"literal":"}"}]},
    ...
    {"name": "EnumReservedDecl$subexpression$1", "symbols": ["NameStrings"]},
